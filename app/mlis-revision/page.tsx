...
export default function MlisRevisionPage() {
    ...
    <main className="relative flex flex-col w-full items-center justify-start bg-white overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[800px] flex flex-col items-center justify-center overflow-hidden pb-[80px]">
        ...
        <div className="max-w-[1000px]">
          ...
          <FadeUp delay={0.4}>
            <p className="text-[16px] sm:text-[18px] md:text-[20px] text-white leading-[1.7]  font-sans mb-12 md:mb-16">
              Educational video discussions on M&A strategy, deal structuring, and legal best practices for tech founders and executives.
            </p>
          </FadeUp>
        </div>
        </div>
       ...
       <section className="relative w-full mt-[60px] md:mt-[100px] flex justify-center items-center pb-[60px] md:pb-[100px]">    
          ...
          before:z-10 ">
                <ImageReveal delay={0.2} direction="left" className="h-[400px] sm:h-[500px] md:h-[600px] lg:h-auto rounded-[24px] md:rounded-[32px]">
                  <Image 
                ...
                <div className="flex flex-col gap-8 md:gap-[40px] w-full">                                  
                    <div className="w-full">
                      ...
                      <h3 className="text-[20px] md:text-[24px] lg:text-[30px] font-heading font-bold text-black mb-3">
                        M&A Trends in AI: What Founders Need to Know in 2026
                      </h3>
                      </FadeUp>
                      <FadeUp delay={0.6}>
                      <p className="text-[15px] sm:text-[16px] md:text-[18px] lg:text-[20px] font-sans text-black mb-6 leading-relaxed">
                        Join Syeda for a deep dive into the latest M&A trends in the AI space, including valuation multiples, deal structures, and regulatory considerations.
                      </p>
                      </FadeUp>
                      <ul className="space-y-[22px]">
                        <FadeUp delay={0.8}>
                        <li className=" md:text-[20px] flex items-center gap-[10px]  font-sans text-black leading-[28px] md:leading-[30px]"> <CiCalendarDate className="text-[40px]" /> May 15, 2026</li>
                        </FadeUp>
                        <FadeUp delay={0.10}>
                        <li className="md:text-[20px] flex items-center gap-[10px] font-sans text-black leading-[28px] md:leading-[30px]"><IoTimeOutline className="text-[40px]"/>
 2:00 PM PT</li>
                        </FadeUp>
                        <FadeUp delay={0.12}>
                        <li className="md:text-[20px] flex items-center gap-[10px] font-sans text-black leading-[28px] md:leading-[30px]"><LuUsers className="text-[40px]" />
 Syeda Nazifa Nawroj, Esq., Guest: PE Investo</li>
                        </FadeUp>
                      </ul>
                      <FadeUp delay={0.14}>
                      <button className="bg-primary hover:bg-[#153a6a] mt-[30px] text-white py-[14px] px-[36px] md:py-[16px] md:px-[40px] lg:px-[50px] rounded-[40px] text-[15px] md:text-[16px] lg:text-[18px] font-normal leading-none transition-all cursor-pointer border-none">
                  Register Now
                </button>
                    </FadeUp>
                    </div>                  
                    ...
                    <div className="w-full lg:w-[40%] max-w-[650px] flex flex-col items-start gap-5">
                      <FadeUp delay={0.2}>
                        <p className="text-[16px] md:text-[18px] lg:text-[20px] font-sans text-black leading-relaxed">
                          Register to unlock our library of past M&A discussions, webinars, and expert insights designed for founders and investors.
                        </p>
                      </FadeUp>
                      <FadeUp delay={0.4}>
      ...
      <section className="my-[60px] md:my-[100px]">
        ...
        text-black font-sans mb-[23px] font-medium max-w-[840px] mx-auto">
          Access summaries, key takeaways, and transcripts from MLIS episodes—designed to make complex discussions easy to revisit and apply.
        </p>
        </FadeUp>
        <FadeUp delay={0.6}>
