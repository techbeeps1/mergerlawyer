...
const steps = [
  { id: 1, title: "Elite Training", desc: "Trained at DLA Piper and Fenwick, two of the country's top tech M&A practices, I bring big-law deal expertise to founder-side transactions." },
  { id: 2, title: "Experienced Insight", desc: "I've worked both sides of the table. You'll see their moves before they make them." },
  { id: 3, title: "Bespoke Specialist Model", desc: "I bring in specialists only when your deal needs them — no unnecessary overhead, just the right expertise at the right time." },
  { id: 4, title: "Technology-Enabled Precision", desc: "Enterprise tools and automated systems cut inefficiency. You get sharp deal work, not bloated process." },
  { id: 5, title: "Boutique Pricing", desc: "Big Law pricing doesn't work for most founders. I offer elite M&A counsel with flat fees and cost certainty around liquidity events." }
];
  ...
  return (
      ...
      <div className="relative z-20 w-full container px-4 sm:px-8 md:px-6 lg:px-10 h-full flex flex-col justify-start pt-8 md:pt-32 pb-0 flex-1 md:min-h-[800px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start mt-4 md:mt-[240px] lg:mt-[300px] w-full h-full pb-10 md:pb-20 gap-16 md:gap-4 lg:gap-0 z-20">
          ...
          <div className="w-full md:w-[40%] lg:w-[32%] flex flex-col items-center md:items-start text-center md:text-left gap-4 md:gap-5 lg:gap-6 drop-shadow-md">
            <FadeUp delay={0.2}>
              <h2 className="text-[36px] sm:text-[40px] md:text-[32px] lg:text-[44px] xl:text-[50px] font-bold font-heading text-white leading-none">M&A Counsel</h2>
            </FadeUp>
          ...
          <div className="w-full md:w-[40%] lg:w-[32%] flex flex-col items-center md:items-start text-center md:text-start gap-4 md:gap-5 pb-10 drop-shadow-md mt-8 md:mt-0">
            <FadeUp delay={0.4}>
              <h2 className="text-[36px] sm:text-[40px] md:text-[32px] lg:text-[44px] xl:text-[50px] font-bold font-heading text-white leading-none">For Tech Deals</h2>
            </FadeUp>
            <FadeUp delay={0.5}>
              <p className="text-[15px] md:text-[13px] lg:text-[16px] text-white/90 leading-relaxed max-w-[420px]">
                When your buyer shows up with a full team — PE fund, AmLaw counsel, and financial advisors — you need someone in your corner who has been on that side of the table. Merger Lawyer gives founders the deal expertise to compete, protect value, and close on your terms.
              </p>
            </FadeUp>
            <FadeUp delay={0.6}>
    ...
    <section className="relative w-full bg-bg-color py-20 md:py-32 overflow-hidden flex justify-center items-center">
      ...
      <div className="relative z-10 w-full container px-4 sm:px-8 md:px-10 flex flex-col items-center text-center">
        ...
        <p className="mt-6 md:mt-4 text-[16px] lg:text-[20px] font-sans font-medium text-black leading-relaxed lg:leading-[34px] text-center">
          Most founders walk into M&A deals outmatched. Whether you are acquiring a company or selling one, the moment a term sheet is being discussed, you are in a high-stakes negotiation with significant consequences. On one side of the table: experienced M&A counsel, financial advisors, and often a private equity sponsor or corporate development team that has structured dozens of transactions like yours. On the other: a founder or operator who has built something valuable — and who may be navigating this process for the first or second time. The gap between those two levels of preparation is where deal value is lost, terms shift, and outcomes disappoint. Merger Lawyer was built to put elite M&A counsel on your side of that table.
        </p>
        </FadeUp>
        <FadeUp delay={0.7}>
    ...
    <section className="w-full bg-white py-20 md:py-32 flex flex-col items-center overflow-hidden">
      ...
      <h2 className="relative z-20 text-[32px] sm:text-[40px] md:text-[50px] lg:text-[64px] font-heading font-medium text-black leading-[42px] md:leading-[60px] lg:leading-[74px] text-center max-w-[800px] px-4 mb-12 md:mb-24">
        Why Founders Choose<br />Merger Lawyer
      </h2>
      </FadeUp>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Desktop Left Column */}
                <div className={`hidden md:flex flex-1 justify-end pr-12 lg:pr-16 w-full ${isEven ? 'invisible' : ''}`}>
                  {!isEven && (
                    <div className={`w-full max-w-[510px] rounded-[24px] md:rounded-[30px] py-6 px-5 md:py-[35px] md:px-[25px] transition-all duration-500 border ${isActive ? 'bg-secondary border-transparent scale-[1.02] md:scale-105' : 'bg-secondary/30 border-secondary shadow-[2px_2px_24px_0px_rgba(0,0,0,0.15)]'}`}>
                ...
                <div className="absolute top-1/2 -translate-y-1/2 md:top-auto md:translate-y-0 left-0 md:relative md:left-auto flex justify-center items-center shrink-0 w-[45px] md:w-[90px]">
                  ...
                  <div className={`absolute w-[45px] h-[45px] md:w-[90px] md:h-[90px] rounded-full bg-white z-[5] transition-all duration-500 ${isActive ? 'scale-110' : ''}`}></div>

                  <div className={`relative w-[45px] h-[45px] md:w-[90px] md:h-[90px] rounded-full flex items-center justify-center font-bold text-[24px] md:text-[50px] leading-none md:leading-[64px] transition-all duration-500 z-10 border border-[#0E326B] shadow-none ${isActive ? 'bg-[#0E326B] text-white scale-110' : 'bg-[#0E326B66] text-[#0E326B]'}`}>
                    {step.id}
                  </div>
                </div>
    ...
    <section className="w-full bg-[#E5EAEF] py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="w-full container px-4 sm:px-8 relative z-10 flex flex-col items-center">
        ...
        <h2 className="text-[36px] sm:text-[40px] md:text-[50px] lg:text-[64px] font-heading font-medium text-[#111111] leading-[42px] md:leading-[60px] lg:leading-[74px] text-center mb-6">
          Legal Services Built Around<br />the Deal Lifecycle
        </h2>
        </FadeUp>
        ...
        <p className="max-w-[900px] text-[16px] md:text-[18px] lg:text-[20px] font-sans font-medium text-[#111111] leading-relaxed text-center mb-16">
          From transaction strategy to closing execution, Merger Lawyer supports founders and private companies with focused counsel across key M&A and corporate matters.
        </p>
        </FadeUp>
        {/* 3-Column Grid */}
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-y-[58px] lg:gap-y-[20px] gap-x-[20px] items-stretch">
          ...
          <div className="flex flex-col gap-[58px]">
            {/* Box 1 */}
            <AnimatedCard delay={0.1} className="bg-secondary relative max-h-fit text-white px-[20px] py-[60px] rounded-[30px] text-center group hover:bg-primary transition-colors duration-300 cursor-pointer h-full">
              <h3 className="text-[24px] md:text-[26px] leading-[30px] font-medium font-heading mb-4">Buy-Side M&A</h3>
              <p className="text-[16px] md:text-[20px] md:leading-[30px] leading-[28px] font-sans mb-8">
                Strategic legal support for acquisitions, asset deals, stock deals, diligence, negotiation, and closing execution.
              </p>
              <a href="#" className="mt-auto w-[70px] h-[70px] absolute bottom-[-34px] left-1/2 -translate-x-1/2 rounded-full bg-[#11336C] flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110 z-10">
                <FiArrowUpRight size={32} />
              </a>
            </AnimatedCard>
            
            {/* Box 2 */}
            <AnimatedCard delay={0.2} className="bg-secondary relative  max-h-fit text-white px-[20px] py-[60px] rounded-[30px] text-center group hover:bg-primary transition-colors duration-300 cursor-pointer h-full">
              <h3 className="text-[24px] md:text-[26px] leading-[30px] font-medium font-heading mb-4">M&A Preparation</h3>
              <p className="text-[16px] md:text-[20px] md:leading-[30px] leading-[28px] font-sans mb-8">
                Pre-sale cleanup, diligence readiness, legal issue-spotting, and structural preparation to reduce friction before going to market.
              </p>
              <a href="#" className="mt-auto w-[70px] h-[70px] absolute bottom-[-34px] left-1/2 -translate-x-1/2 rounded-full bg-[#11336C] flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110 z-10">
                <FiArrowUpRight size={32} />
              </a>
          ...
          <div className="flex flex-col h-full min-h-[500px]">
            <AnimatedCard delay={0.3} className="bg-[#1C4A87] h-full text-white px-[20px] pt-[40px] pb-[30px] rounded-[30px] flex flex-col items-center text-center relative overflow-hidden shadow-xl">
              <h3 className="text-[24px] md:text-[26px] leading-[30px] font-medium font-heading mb-4">General Corporate Counsel</h3>
              <p className="text-[16px] md:text-[20px] md:leading-[30px] leading-[28px] mb-8 px-4 flex-grow">
                Ongoing legal guidance for governance, contracts, compliance, hiring/firing, and day-to-day business support.
              </p>             
              <div className="w-full relative mt-[50px] rounded-[20px]">
                <ImageReveal delay={0.2} direction="bottom" className="rounded-[20px]">
                  <Image src="/service_img.jpg" alt="Corporate Counsel" height={369} width={409} className="w-full h-auto object-cover" />
                </ImageReveal>
                 <Link href="#" className="w-[70px] h-[70px] absolute top-[-33px] left-1/2 -translate-x-1/2 rounded-full bg-[#58A9D3] flex items-center justify-center text-white transition-transform duration-300 hover:scale-110 z-10 shrink-0">
                <FiArrowUpRight size={32} />
              </Link>
              </div>
            </AnimatedCard>
          ...
          <div className="flex flex-col gap-[58px]">
            {/* Box 3 */}
            <AnimatedCard delay={0.4} className="bg-secondary relative  max-h-fit text-white px-[20px] py-[60px] rounded-[30px] text-center group hover:bg-primary transition-colors duration-300 cursor-pointer h-full">
              <h3 className="text-[24px] md:text-[26px] leading-[30px] font-medium font-heading mb-4">Sell-Side M&A</h3>
              <p className="text-[16px] md:text-[20px] md:leading-[30px] leading-[28px] font-sans mb-8">
                Counsel for founders preparing for sale, evaluating terms, protecting value, and managing the path to a smoother exit.
              </p>
              <a href="#" className="mt-auto w-[70px] h-[70px] absolute bottom-[-34px] left-1/2 -translate-x-1/2 rounded-full bg-[#11336C] flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110 z-10">
                <FiArrowUpRight size={32} />
              </a>
            ...
            {/* Box 4 */}
            <AnimatedCard delay={0.5} className="bg-secondary relative  max-h-fit text-white px-[20px] py-[60px] rounded-[30px] text-center group hover:bg-primary transition-colors duration-300 cursor-pointer h-full">
              <h3 className="text-[24px] md:text-[26px] leading-[30px] font-medium font-heading mb-4">Other Complex<br />Transactions</h3>
              <p className="text-[16px] md:text-[20px] md:leading-[30px] leading-[28px] font-sans mb-8">
                Support for recapitalizations, reorganizations, spin-offs, joint ventures, and other high-stakes strategic matters.
              </p>
              <a href="#" className="mt-auto w-[70px] h-[70px] absolute bottom-[-34px] left-1/2 -translate-x-1/2 rounded-full bg-[#11336C] flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110 z-10">
                <FiArrowUpRight size={32} />
              </a>
    ...
    before:-z-10">
        ...
        <div>
          ...
          <p className="lg:text-[20px] text-[16px] lg:leading-[30px] leading-[28px] text-black font-medium mb-4">
            Syeda Nazifa Nawroj is the founder and principal attorney behind Merger Lawyer, a California-based boutique practice built to help founders and private companies navigate serious business transactions with clarity and strength. Before launching her firm, she advised on more than 35 M&A transactions totaling nearly $3 billion in deal value. She trained at DLA Piper and Fenwick, served as an editor of the NYU Law Review, and built her practice around the idea that elite deal counsel should be more accessible, more strategic, and more aligned with founder realities.
          </p>
          </FadeUp>
           <FadeUp delay={0.6}>
          ...
          {!isPlaying && (
            <>
              ...
              <div 
                ...
                onClick={handlePlay}
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg" className="ml-1 w-6 h-6 md:w-10 md:h-10">
          ...
          {testimonials.map((t, idx) => (
            ...
            <div key={t.id + '-' + idx} className="bg-secondary rounded-[20px] p-[24px] md:p-[30px] flex flex-col items-center text-center text-white w-[85vw] sm:w-[350px] md:w-[calc(33.333vw-2.2rem)] min-w-[280px] shrink-0 shadow-md h-auto">
              ...
              <div className="flex flex-col items-center mt-auto w-full">
                <p className="text-[16px] md:text-[18px] lg:text-[20px] font-sans font-bold">{t.name}</p>
                <p className="text-[16px] md:text-[18px] lg:text-[20px] font-sans font-bold mt-1 mb-4">{t.company}</p>
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} width="20" height="20" viewBox="0 0 24 24" fill="#FCD34D" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-6 md:gap-8 mb-10">
            ...
            <div className="flex items-start gap-4">              
              ...
              <div>                 
                ...
                <p className="text-[16px] md:text-[18px] lg:text-[20px] font-sans text-black">
                  Get practical, easy-to-understand guidance that helps founders navigate the M&A process with more confidence, less confusion, and better strategic awareness.
                </p>               
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[16px] md:text-[18px] lg:text-[20px] font-sans text-black">
                  Access trusted legal and deal insight before hiring counsel, so founders can start preparing smarter, ask better questions, and avoid costly missteps early.
                </p>                
              </div>              
            </div>
            </FadeUp>
    ...
    before:z-10 ">
      <ImageReveal delay={0.1} direction="left">
          ...
          <p className="absolute z-20 bottom-[24px] md:bottom-[34px] px-[24px] md:px-[30px] text-white text-[18px] sm:text-[20px] md:text-[24px] lg:text-[34px] leading-[1.3] md:leading-[32px] lg:leading-[44px] italic font-heading font-bold">
            “In M&A, the difference isn’t just the deal you make — it’s the value you protect.”
          </p>
          <p className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[54px] font-bold z-20 text-white/40 absolute top-[20px] md:top-[37px] right-[10px] md:right-[18px] rotate-180
      [writing-mode:vertical-rl]">Merger Lawyer</p>
        </div>
          ...
          <div className="flex flex-col gap-8 md:gap-[40px] w-full">                                  
              <div className="w-full">
                ...
                <p className="text-[15px] sm:text-[16px] md:text-[18px] lg:text-[20px] font-sans text-black/80 mb-6 leading-relaxed">
                  Practical articles for founders preparing for acquisitions, negotiations, and major transaction decisions.
                </p>
                </FadeUp>
                <FadeUp delay={0.2}>
            ...
            <div className="w-full mt-2">
              <FadeUp delay={0.2}>
                ...
                <FadeUp delay={0.2}>
                <p className="text-[15px] sm:text-[16px] md:text-[18px] lg:text-[20px] font-sans text-black/80 mb-6 leading-relaxed">
                 Conversations and educational sessions exploring M&A topics, deal strategy, and founder-side insight.
                </p>
                </FadeUp>
                <FadeUp delay={0.2}>
                <button className="bg-primary hover:bg-[#153a6a] text-white py-[14px] px-[36px] md:py-[16px] md:px-[40px] lg:px-[50px] rounded-[40px] text-[15px] md:text-[16px] lg:text-[18px] font-normal leading-none transition-all cursor-pointer border-none">
