    ...
    <main className="relative flex flex-col w-full min-h-screen items-center justify-start bg-white overflow-x-hidden">
      ...
      <section className="relative w-full z-20 -mt-[100px] lg:-mt-[105px] mb-32">
        <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-x-8 gap-y-20 md:gap-x-6 md:gap-y-24 lg:gap-x-8 lg:gap-y-20">
          ...
          {/* Card 1: M&A */}
          <AnimatedCard delay={0.1} className="lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            ...
            <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[64px] h-[64px] rounded-full bg-[#11336C] flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110 shadow-lg">
              <FiArrowUpRight size={28} />
            </div>
          </AnimatedCard>

          {/* Card 2: Fundraising */}
          <AnimatedCard delay={0.2} className="lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            <h3 className="text-[30px] font-heading font-bold text-[#111111] group-hover:text-white mb-6 leading-[40px]">
              Fundraising
            </h3>
            <p className="text-[20px] text-[#111111] group-hover:text-white font-medium leading-[30px] text-center">
          ...
          <AnimatedCard delay={0.3} className="lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            <h3 className="text-[30px] font-heading font-bold text-[#111111] group-hover:text-white mb-6 leading-[40px]">
          ...
          <AnimatedCard delay={0.4} className="lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            <h3 className="text-[30px] font-heading font-bold text-[#111111] group-hover:text-white mb-6 leading-[40px]">
          ...
          <AnimatedCard delay={0.5} className="lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            <h3 className="text-[30px] font-heading font-bold text-[#111111] group-hover:text-white mb-6 leading-[40px]">
              Privacy (AI & Data)
            </h3>
            <p className="text-[20px] text-[#111111] group-hover:text-white font-medium leading-[30px] text-center">
          ...
          <AnimatedCard delay={0.6} className="lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            <h3 className="text-[30px] font-heading font-bold text-[#111111] group-hover:text-white mb-6 leading-[40px]">
          ...
          <AnimatedCard delay={0.7} className="lg:col-start-2 lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            <h3 className="text-[30px] font-heading font-bold text-[#111111] group-hover:text-white mb-6 leading-[40px]">
              Business Formation
            </h3>
            <p className="text-[20px] text-[#111111] group-hover:text-white font-medium leading-[30px] text-center">
          ...
          <AnimatedCard delay={0.8} className="lg:col-span-2 relative bg-secondary rounded-[20px] py-[60px] px-[24px] flex flex-col items-center text-center shadow-xl h-full group cursor-pointer transition-colors hover:bg-primary">
            <h3 className="text-[30px] font-heading font-bold text-[#111111] group-hover:text-white mb-6 leading-[40px]">
              Non-Profit
            </h3>
            <p className="text-[20px] text-[#111111] group-hover:text-white font-medium leading-[30px] text-center">
